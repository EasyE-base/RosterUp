...
DROP POLICY IF EXISTS "Organizations can manage their website pages" ON website_pages;
DROP POLICY IF EXISTS "Organizations can manage their website content blocks" ON website_content_blocks;
DROP POLICY IF EXISTS "Public can view published website pages" ON website_pages;
DROP POLICY IF EXISTS "Public can view content blocks on published pages" ON website_content_blocks;
