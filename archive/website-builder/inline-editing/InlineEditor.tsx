    ...
    return (
      <div className={`relative group ${className}`} style={style}>
        {value ? (
          ...
          <div
            className={`w-full h-64 border-2 border-dashed rounded-xl flex flex-col items-center justify-center transition-all ${editMode
  ...
  if (type === 'textarea') {
    return (
      <textarea
        ...
        className={`w-full px-3 py-2 bg-transparent border ${editMode
  ...
  if (editMode && !isElementSelected) {
    return (
      <input
        ...
        placeholder={placeholder}
        className={`${getDefaultClasses()} outline-none focus:ring-2 focus:ring-blue-500/50 rounded px-2 py-1 bg-transparent border-0 w-full ${className}`}
