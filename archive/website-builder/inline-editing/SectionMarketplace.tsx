...
interface SectionTemplate {
  ...
  name: string;
  description: string;
  category: 'hero' | 'content' | 'gallery' | 'schedule' | 'contact' | 'commitments' | 'navigation' | 'testimonials' | 'faq' | 'pricing';
  icon: any;
...
const sectionTemplates: SectionTemplate[] = [
  ...
  },
  {
    ...
    description: 'Showcase reviews and social proof from clients',
  ...
  },
  {
    id: 'stats',
    name: 'Key Statistics',
    description: 'Showcase numbers and achievements',
    category: 'content',
    icon: TrendingUp,
    preview: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)',
    isNew: true,
  ...
  },
  {
    id: 'cta',
    name: 'Call to Action',
    description: 'High-impact section to drive conversions',
    category: 'content',
    icon: Zap,
  ...
  },
  {
    id: 'footer',
    name: 'Simple Footer',
    description: 'Footer with logo, copyright, and social links',
    category: 'navigation',
    icon: Layout,
  ...
  },
  {
    id: 'pricing',
    name: 'Pricing Tables',
    description: 'Clear pricing plans with features and CTAs',
    category: 'pricing',
    icon: CreditCard,
    preview: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)',
    isNew: true,
