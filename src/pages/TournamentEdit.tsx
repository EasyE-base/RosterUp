...
export default function TournamentEdit() {
  ...
  const loadTournament = async () => {
    try {
      ...
      setFormData({
        ...
        classification_acceptance: (data.classification_acceptance || 'OPEN') as TournamentClassificationAcceptance,
        accepted_classifications: (data.accepted_classifications || []) as TeamClassification[],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!organization) {
        throw new Error('You must be an organization to edit tournaments');
      }
  ...
  return (
    <div className="min-h-screen bg-[rgb(251,251,253)] pt-32 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <AppleHeading level={1} size="card" className="mb-2">Edit Tournament</AppleHeading>
          <p className="text-[rgb(134,142,150)] text-lg">Update your tournament information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <AppleCard>
            <AppleCardContent className="p-6 space-y-6">
              ...
              <AppleTextarea
                label="Requirements (Optional, one per line)"
          ...
          <div className="flex gap-4">
            ...
            <AppleButton
              ...
              disabled={saving}
              loading={saving}
              leftIcon={!saving && <Trophy className="w-5 h-5" />}
              fullWidth
            >
              Save Changes
            </AppleButton>
