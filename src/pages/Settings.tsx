        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div className="lg:col-span-1">
            ...
            <button
              ...
              className="w-full mt-4 flex items-center justify-center space-x-2 px-4 py-3 bg-slate-800/50 border border-slate-700 text-white rounded-lg hover:bg-slate-800 transition-all"
            >
          ...
          <div className="lg:col-span-3">
              ...
              <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={user?.id || ''}
                        disabled
                        className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-lg text-slate-400 cursor-not-allowed font-mono text-sm"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-slate-800 pt-6">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="px-5 py-3 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 transition-all flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
            ...
            {activeTab === 'notifications' && (
              <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <label className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg cursor-pointer">
                    <div>
                  ...
                  <label className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg cursor-pointer">
                    <div>
                      <p className="text-white font-medium">Tryout Applications</p>
                      <p className="text-slate-400 text-sm">
                  ...
                  <label className="flex items-center justify-between p-4 bg-slate-800/50 rounded-lg cursor-pointer">
                    <div>
                      <p className="text-white font-medium">Team Invitations</p>
                      <p className="text-slate-400 text-sm">
                ...
                <button
                  ...
                  disabled={loading}
                  className="mt-6 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
              ...
              <div className="bg-slate-900/50 border border-slate-800/50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-white font-medium rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
                        <Loader2 className="w-5 h-5 animate-spin" />
