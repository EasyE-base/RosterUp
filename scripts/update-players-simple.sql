-- Simple approach: Update all 10 softball players at once using a DO block
...
BEGIN
    -- Get the IDs of all 10 softball players in order
    SELECT ARRAY_AGG(id ORDER BY created_at), ARRAY_AGG(user_id ORDER BY created_at)
    INTO player_ids, player_user_ids
    FROM player_profiles
    WHERE sport = 'Softball'
    LIMIT 10;

    -- Update Player 1: Emma Johnson
    UPDATE profiles SET full_name = 'Emma Johnson' WHERE id = player_user_ids[1];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Pitcher', 'First Base']),
        age_group = '10U',
        classification = 'A',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[1];

    -- Update Player 2: Sophia Martinez
    UPDATE profiles SET full_name = 'Sophia Martinez' WHERE id = player_user_ids[2];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Shortstop', 'Second Base']),
        age_group = '10U',
        classification = 'B',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[2];

    -- Update Player 3: Olivia Chen
    UPDATE profiles SET full_name = 'Olivia Chen' WHERE id = player_user_ids[3];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Catcher']),
        age_group = '12U',
        classification = 'A',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[3];

    -- Update Player 4: Ava Thompson
    UPDATE profiles SET full_name = 'Ava Thompson' WHERE id = player_user_ids[4];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Outfield', 'Third Base']),
        age_group = '8U',
        classification = 'C',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[4];

    -- Update Player 5: Isabella Garcia
    UPDATE profiles SET full_name = 'Isabella Garcia' WHERE id = player_user_ids[5];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Pitcher', 'Outfield']),
        age_group = '12U',
        classification = 'A',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[5];

    -- Update Player 6: Mia Anderson
    UPDATE profiles SET full_name = 'Mia Anderson' WHERE id = player_user_ids[6];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['First Base', 'Third Base']),
        age_group = '10U',
        classification = 'B',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[6];

    -- Update Player 7: Charlotte Williams
    UPDATE profiles SET full_name = 'Charlotte Williams' WHERE id = player_user_ids[7];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Second Base', 'Shortstop']),
        age_group = '10U',
        classification = 'C',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[7];

    -- Update Player 8: Amelia Davis
    UPDATE profiles SET full_name = 'Amelia Davis' WHERE id = player_user_ids[8];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Outfield']),
        age_group = '12U',
        classification = 'B',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[8];

    -- Update Player 9: Harper Brown
    UPDATE profiles SET full_name = 'Harper Brown' WHERE id = player_user_ids[9];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Third Base', 'Pitcher']),
        age_group = '8U',
        classification = 'C',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[9];

    -- Update Player 10: Evelyn Miller
    UPDATE profiles SET full_name = 'Evelyn Miller' WHERE id = player_user_ids[10];
    UPDATE player_profiles SET
        ...
        position = to_jsonb(ARRAY['Shortstop', 'Pitcher']),
        age_group = '12U',
        classification = 'A',
        ...
        is_active = true,
        updated_at = NOW()
    WHERE id = player_ids[10];

    RAISE NOTICE 'Successfully updated all 10 softball player profiles!';
END $$;
