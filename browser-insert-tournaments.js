// Copy and paste this into your browser console while logged in to http://localhost:5173/tournaments

const insertTournaments = async () => {
  // Get supabase instance from window (should be available when logged in)
  ...
  console.log('Inserting 10 tournaments...');
  ...
  console.log(`✅ Successfully added ${data.length} tournaments!`);
